...
/**
 * https://github.com/BJTheCod3r/laravel-cloudflare-stream
 * version 1.0.4
 */
namespace App\Providers\CloudflareStreamService;

use App\Providers\CloudflareStreamService\Params\QueryParams;
...
class CloudflareStream
{
    ...
    /**
     * @author @hoodedice
     * Get the url for a resumable (tsu) cloudflare upload. Pass this directly to the client.
     * @param
     */
    public function getUrlForResumableUpload() {}
